...
export default function AgriInputPurchase(){
                ...
                <AccordionItemHeading>
                  <AccordionItemButton>
                    <span className="d-flex row col-12">
                      <span className="col-4 border-right1">{data.name}</span>
                      <span className="col-4 text-center border-right1 row">
                        <div className="col-4">
                            <img src={person} style={{height:'50px',width:'50px',borderRadius:"50%"}} />
                        </div>
                        <div className="col-8">
                          <span>{data.person}</span><br/>
                          <span className="text-muted">Mon,13 April,10:42 am</span>
                        </div>

                      </span>
                      {/* {data.tabdata.map((tabledata)=> */}
                      <button className="col-4 excelbutton">
                        ...
                        <span className="col-5 pr-5 text-center">{data.excelName}</span>
                      ...
                      <svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          >
                            <Modal.Header closeButton>
                              <Modal.Title><h4>{tabledata.category}</h4></Modal.Title>
                            </Modal.Header>
                            <Modal.Body>
                              <div className=""> 
                                <h6>Description : {tabledata.des}</h6>
                                <h6>Quantity : {tabledata.quantity}</h6>
